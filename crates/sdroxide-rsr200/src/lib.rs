...
//! (2026-08-24, wired and over WiFi — real spectrum, tuning and the
//! attenuators all working; see `RSR200_PLAN.md`'s own step 3 entry for the
//! decimation/throughput ceiling that run turned up). Not yet: 24-bit, dual
//! channel (Separate mode + `sdroxide_dsp::Diversity` wiring, step 4),
//! hardware diversity (step 6), or USB (step 7) — single channel, 16-bit,
//! LAN is the whole of what streams today.
